...
%% Load Data
%% Load Data
results_folder = 'E:\OneDrive - The University Of Hong Kong\Postdoc\5_Paper\Results_aug_20201119\densenet201';
if ~exist(results_folder, 'dir')
    mkdir(results_folder);
end
imdsTrain =  imageDatastore('E:\OneDrive - The University Of Hong Kong\Postdoc\5_Paper\ImageData_strain_20200901_crop\TrainData', ...
    'IncludeSubfolders',true, ...
    'LabelSource','foldernames');
imdsValidation = imageDatastore('E:\OneDrive - The University Of Hong Kong\Postdoc\5_Paper\ImageData_strain_20200901_crop\TestData', ...
    'IncludeSubfolders',true, ...
    'LabelSource','foldernames');
...
finalConvLayerName = "conv5_block32_2_conv";
...
result_ambiguity=table(top10Idx,TestImageNameIdx,top10Ambiguity,mostLikely,LikeliestPoss,secondLikely,SecondPoss,imdsValidation.Labels(ambiguityIdx),...
    'VariableNames',["Image #","Image Name","Ambiguity","Likeliest","Likeliest Possibility","Second","Second Possibility","True Class"]);
...
%%
filename = 'All results.mat';
save(filename)
save(string(results_folder)+'\'+'Results.mat');
%%
writematrix(YPred, string(results_folder)+'\'+'Y_Pred.csv');
writematrix(probs, string(results_folder)+'\'+'Y_Pred_probs.csv');
%%
% writetable(struct2table(info), string(results_folder)+'\'+'network_info.xlsx')
%% 
