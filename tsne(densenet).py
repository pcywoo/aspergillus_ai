...
classifier = nn.Sequential(collections.OrderedDict([('fc1', nn.Linear(1024,500)),
                                                    ('relu', nn.ReLU()),
                                                    ('fc2',nn.Linear(500,4)),
                                                    ('output',nn.LogSoftmax(dim=1))]))
model = torchvision.models.densenet121(pretrained=False) #resnet18
# 本次任務需要辨認4種真菌
