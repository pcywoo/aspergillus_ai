...
# 实例化類神經網路并且移动到GPU
model = torchvision.models.inception_v3(pretrained=False)  # resnet18
...
ax[1].set_title(
    't-SNE scattered plot of fungal images through trained Inception-v3 neural networks')
...
ax3.set_title('Heatmap of actual classification of fungi to predict of pictures of fungi through Inception-v3 neural network')
