...
for i in range(0,finalepoch+1,1):
    if i!=finalepoch:
        xtick_loc_train.append(i*176)
    else:
        xtick_loc_train.append(i*176-1)

xtick_label_train= []
for i in range(0,finalepoch+1,1):     
    xtick_label_train.append(i*176)

xtick_loc_validate= []
for i in range(0,finalepoch+1,1):
    if i!=finalepoch:
        xtick_loc_validate.append(i*176)
    else:
        xtick_loc_validate.append(i*176-1)

xtick_label_validate= []
for i in range(0,finalepoch+1,1):  
    xtick_label_validate.append(i*176)
...
train_loss_curve = train_loss_ax.plot(range(finalepoch*176), train_loss, label='train loss',color="r")
validate_loss_curve = validate_loss_ax.plot(range(finalepoch*176), validate_loss, label='validate loss',color="g")

train_accuracy_curved = train_accuracy_ax.plot(range(finalepoch*176), train_accuracy,label='train accuracy',color="r")
validate_accuracy_curved= validate_accuracy_ax.plot(
    range(finalepoch*176), validate_accuracy, label='validate accuracy',color="g")
...
# 繪製準確率對迭代次數圖表_number
# fig1, ax1 = plt.subplots(2, 1, figsize=(18, 40))
# #ax1[0].set_title(
#     #'loss to iteration during training and validating\n of Inception-v3 neural network',fontsize=40)
# #ax1[1].set_title(
#     #'accuracy to iteration during training and validating\n of Inception-v3 #neural network',fontsize=40)
...
# twinax0.set_xticks(xtick_loc,range(0, finalepoch+1, 1),fontsize=50)
# twinax1.set_xticks(xtick_loc,range(0, finalepoch+1, 1),fontsize=50)
# twinax0.set_xlabel('Epoch',fontsize=60)
# twinax1.set_xlabel('Epoch',fontsize=60)

# f1 = matplotlib.font_manager.FontProperties( size=50)
# ax1[0].legend(prop=f1)
# ax1[1].legend(prop=f1)
# ax1[0].set_xlabel('iteration',fontsize=60)
# ax1[0].set_ylabel('loss',fontsize=60)
# ax1[1].set_xlabel('iteration',fontsize=60)
# ax1[1].set_ylabel('accuracy',fontsize=60)
# ax1[0].xaxis.set_tick_params(labelsize=50)
# ax1[0].yaxis.set_tick_params(labelsize=50)
# ax1[1].xaxis.set_tick_params(labelsize=50)
# ax1[1].yaxis.set_tick_params(labelsize=50)
# fig1.savefig(fname=FOLDER+'/curved.png',dpi=600)
